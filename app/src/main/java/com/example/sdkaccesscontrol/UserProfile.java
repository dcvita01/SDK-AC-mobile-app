            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId ) {
                    ...
                    case  R.id.nav_working:
                        intent = new Intent(UserProfile.this, WorkingFromHome.class);
                        startActivity(intent);
                        break;
                    case  R.id.nav_hours:
                        intent = new Intent(UserProfile.this, WorkingHours.class);
                        startActivity(intent);
                        break;
                    ...
                    case  R.id.nav_settings:
                        intent = new Intent(UserProfile.this, SettingsActivity.class);
                        startActivity(intent);
                        break;
